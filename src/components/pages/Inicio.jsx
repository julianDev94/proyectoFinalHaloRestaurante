...
const Inicio = () => {
  ...
  return (
    <section className="sectionMain">
            ...
            <Col sm={12} xl={6}>
              <Card className="shadow-lg text-center border-0 h-100 rounded">
                <Card.Body className="d-flex flex-column justify-content-center">
                  ...
                  <Button variant="success" className="fs-2">Nuestros platos aqui!</Button>
                </Card.Body>
              </Card>
            </Col>
            <Col sm={12} xl={6}>
      ...
      <article className="text-center mt-3 novedades-seccion">
      ...
      <article className="text-center container-resenias">
        <Container>
